      ...
      <Tabs value={statusFilter} onValueChange={setStatusFilter} className="space-y-6">
        ...
        <TabsContent value={statusFilter} className="space-y-4">
          ...
          <div className="flex items-center gap-3 mb-6">
            {statusFilter === "all" && <Target className="w-6 h-6 text-gray-600" />}
            {statusFilter === "won" && <Trophy className="w-6 h-6 text-green-600" />}
            {statusFilter === "lost" && <XCircle className="w-6 h-6 text-red-600" />}
            {statusFilter === "pending" && <Clock className="w-6 h-6 text-blue-600" />}
            ...
            <Badge variant="outline" className="text-sm px-2 py-1 bg-gray-50 text-gray-600 border-gray-300">
              {filteredBets.length}
            </Badge>
          </div>
...
function BetItem({
  ...
  return (
    <div 
      className={`${statusConfig.bgColor} ${statusConfig.borderColor} border rounded-xl p-5 hover:shadow-md transition-all duration-200 group`}
